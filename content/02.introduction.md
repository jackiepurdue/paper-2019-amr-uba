...
The evolution of resistance to these substances, known as antimicrobial resistance (AMR), is an important and ancient adaptive process [@doi:10.1038/nature10388].
...
These are the leading cause of hospital-acquired infections and are largely only treatable with carbapenem or polymyxin antibiotics [@doi:10.3390/medsci6010001].
...
High-quality manually curated AMR databases such as the Comprehensive Antibiotic Resistance Database (CARD) [@doi.org/10.1093/nar/gkz935] provide a unified resource for the definition, nomenclature and classification of AMR genes.
...
This _in silico_ search is performed using CARD's BLAST-based Resistance Gene Identifier (RGI) tool and greatly increases the sequence diversity in CARD [@doi.org/10.1093/nar/gkz935].
...
Recently, techniques have been developed that allow the recovery of genomes from metagenomic data e.g. [@doi.org/10.7717/peerj.1165,@doi:10.1038/s41564-018-0171-1].
...
Parks et. al. [@doi.org/10.1038/s41564-017-0083-5], generated new 7,903 bacterial and archael (Uncultured Bacteria and Archaea; UBA) MAGs representing >30% increase in the sampled phylogenetic diversity of the bacteria and archaea.
