...
Newly discovered genes could some day fall between these more distantly related clades.
...
After applying filters, only 63 MAG derived genes were retained for the phylogeny.
...
Between MCR 5 and ICR-Mc (figure {#fig:mcr-5mayb-icr}), there appear clades of diversity in the genus *Psychrobacter*.
...
Another clade between these two variants contains phosphoethanolamine transferases from the genus *Stenotrophomonas*, including *S. maltophilia* and *S. acidaminiphila* which is a multidrug-resistant opportunistic pathogen [@doi:10/fxx2tt].
